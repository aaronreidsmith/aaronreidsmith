...
## About me
I'm Aaron Smith, a Senior Data Engineer at [IronNet Cybersecurity](https://www.ironnet.com/) and an active contributor to Python's leading equivalent to R's `auto.arima`, [`pmdarima`](https://github.com/alkaline-ml/pmdarima). Currently working to migrate legacy Spark infrastructure to a Kafka-based streaming architecture.
